...
/**
 * Created by eugeniuparvan on 2/24/17.
 */
public class GluuUserInfoTokenService implements ResourceServerTokenServices {
    ...
    public GluuUserInfoTokenService(String userInfoEndpointUrl, String clientId) {
    ...
    private Map<String, Object> getMap(String path, String accessToken) {
        ...
        try {
            ...
            String body = ((OAuth2RestOperations) ex).exchange(path, HttpMethod.GET, null, String.class, new Object[0]).getBody();
